...
if (isset($_GET['user_id'])) {
    ...
    // SQL query to select data from the "UserCartDetails" table for the given user ID
    $sqlSelect = "SELECT * FROM `UserCartDetails`, `Products` WHERE User_ID = $user_id AND UserCartDetails.Product_id = Products.Product_id";
