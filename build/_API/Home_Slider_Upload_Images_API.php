...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image'], $_POST['caption'], $_POST['content'])) {
        ...
        $uploadDir = 'Home_Slider_Images/'; // Store images in _API/Home_Slider_Images/
        ...
        if (move_uploaded_file($_FILES['image']['tmp_name'], $targetFilePath)) {
            ...
            // SQL query to insert the data into Home_Slider_Images
            $sql = "INSERT INTO Home_Slider_Images (url, caption, content) VALUES ('$url', '$caption', '$content')";
